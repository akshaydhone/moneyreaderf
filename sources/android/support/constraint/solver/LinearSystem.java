...
public class LinearSystem {
    ...
    void displaySystemInformations() {
        ...
        System.out.println("Linear System -> Table size: " + this.TABLE_SIZE + " (" + getDisplaySize(this.TABLE_SIZE * this.TABLE_SIZE) + ") -- row sizes: " + getDisplaySize(rowSize) + ", actual size: " + getDisplaySize(actualRowSize) + " rows: " + this.mNumRows + InternalZipConstants.ZIP_FILE_SEPARATOR + this.mMaxRows + " cols: " + this.mNumColumns + InternalZipConstants.ZIP_FILE_SEPARATOR + this.mMaxColumns + " " + 0 + " occupied cells, " + getDisplaySize(0));
    }
