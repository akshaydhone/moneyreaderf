...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00552();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00541();
    ...
    class C00552 implements OnItemClickListener {
        C00552() {
        }
