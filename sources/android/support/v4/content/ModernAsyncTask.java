...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00571();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03282();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00571 implements ThreadFactory {
    ...
    class C03282 extends WorkerRunnable<Params, Result> {
        C03282() {
        }
