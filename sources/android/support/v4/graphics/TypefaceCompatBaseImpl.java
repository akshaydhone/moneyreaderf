...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03291 implements StyleExtractor<FontInfo> {
        C03291() {
        }
    ...
    class C03302 implements StyleExtractor<FontFileResourceEntry> {
        C03302() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03291());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03302());
    }
