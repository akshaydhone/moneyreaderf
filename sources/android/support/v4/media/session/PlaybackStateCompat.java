...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01031();
    ...
    static class C01031 implements Creator<PlaybackStateCompat> {
        C01031() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01041();
        ...
        static class C01041 implements Creator<CustomAction> {
            C01041() {
            }
