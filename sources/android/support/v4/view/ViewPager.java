...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01391();
    ...
    private static final Interpolator sInterpolator = new C01402();
    ...
    private final Runnable mEndScrollRunnable = new C01413();
    ...
    static class C01391 implements Comparator<ItemInfo> {
        C01391() {
        }
    ...
    static class C01402 implements Interpolator {
        C01402() {
        }
    ...
    class C03484 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01421 implements ClassLoaderCreator<SavedState> {
            C01421() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03484());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, ErrorDialogData.SUPPRESSED);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, ErrorDialogData.SUPPRESSED);
        this.mInLayout = true;
        populate();
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), ErrorDialogData.SUPPRESSED), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, ErrorDialogData.SUPPRESSED));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
