                        ...
                        if (!canSlide || child == this.mSlideableView) {
                            if (lp.weight > 0.0f) {
                                ...
                                if (canSlide) {
                                    ...
                                    child.measure(MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), ErrorDialogData.SUPPRESSED), childHeightSpec);
                                }
                            }
