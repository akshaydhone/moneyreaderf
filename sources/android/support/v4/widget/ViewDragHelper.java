...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C01661();
    ...
    private final Runnable mSetIdleRunnable = new C01672();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C01661 implements Interpolator {
        C01661() {
        }
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r27) {
        /*
        r26 = this;
        r4 = r27.getActionMasked();
        r5 = r27.getActionIndex();
    ...
    public void processTouchEvent(android.view.MotionEvent r22) {
        /*
        r21 = this;
        r3 = r22.getActionMasked();
        r4 = r22.getActionIndex();
    ...
    L_0x0138:
        ...
        goto L_0x002f;
    L_0x019e:
        r14 = r22.getPointerCount();
        r8 = 0;
    L_0x01a3:
        if (r8 >= r14) goto L_0x01e9;
    L_0x01a5:
        r0 = r22;
        r15 = r0.getPointerId(r8);
        r0 = r21;
