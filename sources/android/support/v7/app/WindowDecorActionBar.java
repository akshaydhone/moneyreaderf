...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03931();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03942();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03583();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C03583 implements ViewPropertyAnimatorUpdateListener {
        C03583() {
        }
    ...
    class C03931 extends ViewPropertyAnimatorListenerAdapter {
        C03931() {
        }
    ...
    class C03942 extends ViewPropertyAnimatorListenerAdapter {
        C03942() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0183R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0183R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0183R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0183R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0183R.styleable.ActionBar, C0183R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0183R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0183R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0183R.attr.actionBarWidgetTheme, outValue, true);
