...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0183R.attr.actionBarSize, 16842841};
    ...
    class C01931 extends AnimatorListenerAdapter {
        C01931() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01931();
        this.mRemoveActionBarHideOffset = new C01942();
        this.mAddActionBarHideOffset = new C01953();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0183R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0183R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0183R.id.action_bar));
        }
    }
