    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0183R.id.topPanel) {
                    topPanel = child;
                } else if (id == C0183R.id.buttonPanel) {
                    buttonPanel = child;
                } else if (id != C0183R.id.contentPanel && id != C0183R.id.customPanel) {
                    return false;
                } else {
                    if (middlePanel != null) {
                        return false;
        ...
        if (buttonPanel != null) {
            ...
            buttonPanel.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(buttonHeight, ErrorDialogData.SUPPRESSED));
