...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C02063 implements OnItemSelectedListener {
        C02063() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0183R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0183R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0183R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0183R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0183R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    public void show() {
        ...
        if (!this.mPopup.isShowing()) {
            ...
            popupWindow.update(anchorView, i4, i5, i2, i);
        }
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02052();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02063());
        ...
        switch (this.mDropDownWidth) {
            case -2:
                ...
                break;
            case -1:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), ErrorDialogData.SUPPRESSED);
                break;
            default:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mDropDownWidth, ErrorDialogData.SUPPRESSED);
                break;
        }
