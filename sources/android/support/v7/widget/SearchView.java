...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02113 implements OnFocusChangeListener {
        C02113() {
        }
    ...
    class C02124 implements OnLayoutChangeListener {
        C02124() {
        }
    ...
    class C02146 implements OnKeyListener {
        C02146() {
        }
    ...
    class C02157 implements OnEditorActionListener {
        C02157() {
        }
    ...
    class C02168 implements OnItemClickListener {
        C02168() {
        }
    ...
    class C02179 implements OnItemSelectedListener {
        C02179() {
        }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0183R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C02191();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0183R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C02091();
        this.mReleaseCursorRunnable = new C02102();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02135();
        this.mTextKeyListener = new C02146();
        this.mOnEditorActionListener = new C02157();
        this.mOnItemClickListener = new C02168();
        this.mOnItemSelectedListener = new C02179();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0183R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0183R.styleable.SearchView_layout, C0183R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0183R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0183R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0183R.id.search_plate);
        this.mSubmitArea = findViewById(C0183R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0183R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0183R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0183R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0183R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0183R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0183R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0183R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0183R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0183R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0183R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0183R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0183R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0183R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0183R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0183R.styleable.SearchView_suggestionRowLayout, C0183R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0183R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02113());
        setIconifiedByDefault(a.getBoolean(C0183R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0183R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0183R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0183R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0183R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0183R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0183R.styleable.SearchView_android_focusable, true));
        a.recycle();
        this.mVoiceWebSearchIntent = new Intent("android.speech.action.WEB_SEARCH");
        this.mVoiceWebSearchIntent.addFlags(ErrorDialogData.BINDER_CRASH);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(ErrorDialogData.BINDER_CRASH);
        this.mDropDownAnchor = findViewById(this.mSearchSrcTextView.getDropDownAnchor());
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02124());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0183R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0183R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0183R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0183R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, ErrorDialogData.SUPPRESSED);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        try {
            ...
            if (data != null) {
                ...
                if (id != null) {
                    data = data + InternalZipConstants.ZIP_FILE_SEPARATOR + Uri.encode(id);
                }
            }
