...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0183R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0183R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0183R.attr.textColorSearchUrl, colorValue, true);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor threw exception.", e);
            dropDownView = newDropDownView(this.mContext, this.mCursor, parent);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        ...
        try {
            ...
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + InternalZipConstants.ZIP_FILE_SEPARATOR + resourceId;
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme(Param.CONTENT).authority(authority).query("").fragment("");
