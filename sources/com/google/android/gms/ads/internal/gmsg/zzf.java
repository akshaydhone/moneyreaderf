...
public final class zzf {
    ...
    static final /* synthetic */ void zzb(zzarr zzarr, Map map) {
        ...
        try {
            try {
                JSONArray jSONArray = new JSONObject((String) map.get(DataBufferSafeParcelable.DATA_FIELD)).getJSONArray("intents");
                        ...
                        if (!TextUtils.isEmpty(optString7)) {
                            ...
                            if (parseUri == null) {
                                ...
                                if (!TextUtils.isEmpty(optString6)) {
                                    split = optString6.split(InternalZipConstants.ZIP_FILE_SEPARATOR, 2);
                                    if (split.length == 2) {
