...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C0233R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    L_0x0005:
        r0 = com.google.android.gms.common.wrappers.Wrappers.packageManager(r4);	 Catch:{ NameNotFoundException -> 0x0031 }
        r1 = "com.google.android.gms";
        r2 = 64;
        r0 = r0.getPackageInfo(r1, r2);	 Catch:{ NameNotFoundException -> 0x0031 }
        r1 = com.google.android.gms.common.GoogleSignatureVerifier.getInstance(r4);	 Catch:{ NameNotFoundException -> 0x0031 }
        if (r0 == 0) goto L_0x002d;
    L_0x0017:
        r2 = 0;
        r2 = r1.isGooglePublicSignedPackage(r0, r2);	 Catch:{ NameNotFoundException -> 0x0031 }
        if (r2 != 0) goto L_0x002d;
    L_0x001e:
        r2 = 1;
        r0 = r1.isGooglePublicSignedPackage(r0, r2);	 Catch:{ NameNotFoundException -> 0x0031 }
        if (r0 == 0) goto L_0x002d;
    L_0x0025:
        r0 = 1;
        zzbr = r0;	 Catch:{ NameNotFoundException -> 0x0031 }
    L_0x0028:
        zzbs = r3;
    L_0x002a:
        r0 = zzbr;
    ...
    L_0x0031:
        ...
        android.util.Log.w(r1, r2, r0);	 Catch:{ all -> 0x003c }
        zzbs = r3;
        goto L_0x002a;
    L_0x003c:
        r0 = move-exception;
