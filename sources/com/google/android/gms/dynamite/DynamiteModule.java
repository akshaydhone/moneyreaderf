...
public final class DynamiteModule {
    ...
    public static Uri getQueryUri(String str, boolean z) {
        ...
        return Uri.parse(new StringBuilder((String.valueOf(str2).length() + 42) + String.valueOf(str).length()).append("content://com.google.android.gms.chimera/").append(str2).append(InternalZipConstants.ZIP_FILE_SEPARATOR).append(str).toString());
    }
