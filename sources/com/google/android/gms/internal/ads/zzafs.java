    ...
    public static JSONObject zza(Context context, zzafl zzafl) {
        ...
        try {
            ...
            if (zzane.isLoggable(2)) {
                ...
                zzakb.m29v(zzqn.length() != 0 ? str.concat(zzqn) : new String(str));
            }
