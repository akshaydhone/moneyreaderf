...
public final class zzakk {
            ...
            if (!zzjn.zzarc) {
                ...
                while (view != null) {
                    ...
                    if (parent != null) {
                        ...
                        jSONObject3.put(Param.TYPE, parent.getClass().getName());
    ...
    public final void zza(Context context, List<String> list) {
        ...
        if (list == null) {
            zzakb.m29v("Cannot ping urls: empty list.");
        } else if (zzoh.zzh(context)) {
            zzoh zzoh = new zzoh();
            zzoh.zza(new zzakl(this, list, zzoh, context));
            zzoh.zzd((Activity) context);
        } else {
            zzakb.m29v("Cannot ping url because custom tabs is not supported");
        }
    }
    ...
    public final boolean zzak(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzakp(), intentFilter);
        this.zzcro = true;
        return true;
    }
    ...
    public final boolean zzal(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzako(), intentFilter);
        this.zzcrp = true;
        return true;
    }
