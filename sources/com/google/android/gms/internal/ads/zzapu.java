...
public final class zzapu extends Thread implements OnFrameAvailableListener, zzapt {
    ...
    public final void run() {
        int i = 1;
        if (this.zzczh == null) {
            zzane.m27e("SphericalVideoProcessor started with no output texture.");
        ...
        zzna zzna = zznk.zzazp;
        int zzd = zzd(35633, !((String) zzkb.zzik().zzd(zzna)).equals(zzna.zzja()) ? (String) zzkb.zzik().zzd(zzna) : "attribute highp vec3 aPosition;varying vec3 pos;void main() {  gl_Position = vec4(aPosition, 1.0);  pos = aPosition;}");
        if (zzd == 0) {
            i2 = 0;
        } else {
            zzna zzna2 = zznk.zzazq;
