...
final class zzazk {
    ...
    private static long zzd(byte[] bArr, int i) {
        return ((long) ((((bArr[i] & 255) | ((bArr[i + 1] & 255) << 8)) | ((bArr[i + 2] & 255) << 16)) | ((bArr[i + 3] & 255) << 24))) & InternalZipConstants.ZIP_64_LIMIT;
    }
    ...
    static byte[] zze(byte[] bArr, byte[] bArr2) {
        ...
        j3 = ((j3 | ((j & 67108863) & zza5)) | (j2 << 26)) & InternalZipConstants.ZIP_64_LIMIT;
        j2 = ((j2 >> 6) | (j13 << 20)) & InternalZipConstants.ZIP_64_LIMIT;
        j13 = ((j13 >> 12) | (j4 << 14)) & InternalZipConstants.ZIP_64_LIMIT;
        j5 = (((j5 | (zza4 & zza5)) << 8) | (j4 >> 18)) & InternalZipConstants.ZIP_64_LIMIT;
        j4 = zzd(bArr, 16) + j3;
        j3 = InternalZipConstants.ZIP_64_LIMIT & j4;
        j4 = (j4 >> 32) + (j2 + zzd(bArr, 20));
        j2 = InternalZipConstants.ZIP_64_LIMIT & j4;
        j13 = (j13 + zzd(bArr, 24)) + (j4 >> 32);
        j4 = InternalZipConstants.ZIP_64_LIMIT & j13;
        j13 = ((j13 >> 32) + (j5 + zzd(bArr, 28))) & InternalZipConstants.ZIP_64_LIMIT;
