...
final class zzbcx {
    static String zza(zzbcu zzbcu, String str) {
        ...
        zza(zzbcu, stringBuilder, 0);
        return stringBuilder.toString();
    }

    private static void zza(zzbcu zzbcu, StringBuilder stringBuilder, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (!(!replaceFirst.endsWith("List") || replaceFirst.endsWith("OrBuilderList") || replaceFirst.equals("List"))) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(stringBuilder, i, zzep(valueOf), zzbbo.zza(method2, (Object) zzbcu, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf2.length() != 0 ? str2.concat(valueOf2) : new String(str2))) != null) {
                ...
                if (method2 != null) {
                    boolean equals;
                    zzbcu zza = zzbbo.zza(method2, (Object) zzbcu, new Object[0]);
                    if (method3 == null) {
                        ...
                        equals = ((Boolean) zzbbo.zza(method3, (Object) zzbcu, new Object[0])).booleanValue();
                    }
                    if (equals) {
        ...
        if (zzbcu instanceof zzc) {
            Iterator it = ((zzc) zzbcu).zzdtz.iterator();
            if (it.hasNext()) {
        ...
        if (((zzbbo) zzbcu).zzdtt != null) {
            ((zzbbo) zzbcu).zzdtt.zza(stringBuilder, i);
        }
    }
    ...
    static final void zza(StringBuilder stringBuilder, int i, String str, Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                ...
                zza(stringBuilder, i + 2, Param.VALUE, entry.getValue());
                stringBuilder.append("\n");
                while (i2 < i) {
                    stringBuilder.append(' ');
                    i2++;
