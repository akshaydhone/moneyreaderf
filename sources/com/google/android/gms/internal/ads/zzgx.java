...
public final class zzgx {
    ...
    private static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzane.m27e("Unable to construct shingle");
            return "";
        }
    ...
    private static void zza(int i, long j, String str, int i2, PriorityQueue<zzgy> priorityQueue) {
        ...
        if ((priorityQueue.size() != i || (((zzgy) priorityQueue.peek()).zzajg <= zzgy.zzajg && ((zzgy) priorityQueue.peek()).value <= zzgy.value)) && !priorityQueue.contains(zzgy)) {
