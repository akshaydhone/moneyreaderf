...
public final class zzos extends zzqt implements zzpb {
    ...
    public final void performClick(String str) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m27e("#001 Attempt to perform click before app native ad initialized.");
                return;
            }
    ...
    public final void recordImpression() {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m27e("#002 Attempt to record impression before native ad initialized.");
                return;
            }
    ...
    public final boolean zzh(IObjectWrapper iObjectWrapper) {
        if (this.zzbij == null) {
            zzane.m27e("Attempt to call renderVideoInMediaView before ad initialized.");
            return false;
        } else if (this.zzbig == null) {
            return false;
        } else {
            View view = (FrameLayout) ObjectWrapper.unwrap(iObjectWrapper);
            this.zzbij.zza(view, new zzot(this));
            return true;
        }
    }
