...
public class zzpd implements zzoz {
    ...
    public zzpd(Context context, zzpa zzpa, @Nullable zzacm zzacm, zzci zzci, @Nullable JSONObject jSONObject, @Nullable zzpb zzpb, @Nullable zzang zzang, @Nullable String str) {
    ...
    private final void zza(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6) {
        ...
        try {
            ...
            jSONObject8.put(Param.TIMESTAMP, zzbv.zzer().currentTimeMillis());
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.m27e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        }
    }
    ...
    public final boolean recordImpression(Bundle bundle) {
        ...
        zzane.m27e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
        return false;
    }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.m27e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        }
    }
    ...
    public View zza(OnClickListener onClickListener, boolean z) {
        ...
        View zzom = new zzom(this.mContext, zzkc, layoutParams);
    ...
    public zzaqw zzko() throws zzarg {
        ...
        if (!(this.zzbja == null || this.zzbja.optJSONObject("overlay") == null)) {
            ...
            boolean z = false;
            zzaqw = zzarc.zza(context, zzasi.zzb(zzf), zzf.zzarb, false, z, this.zzbjc, this.zzyf, null, null, null, zzhs.zzhm());
            if (zzaqw != null) {
                zzaqw.getView().setVisibility(8);
                new zzpf(zzaqw).zza(this.zzaad);
            }
        }
        return zzaqw;
    }
