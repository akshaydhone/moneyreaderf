        ...
        synchronized (this.mLock) {
            ...
            if (unwrap instanceof zzpd) {
                ...
                if (zzpd.zzkk()) {
                    ...
                    synchronized (this.mLock) {
                        if (this.zzbij instanceof zzpd) {
                            zzpd = (zzpd) this.zzbij;
                            view2 = (View) this.zzbke.get();
                            if (!(zzpd == null || zzpd.getContext() == null || view2 == null || !zzbv.zzfh().zzu(view2.getContext()))) {
                                zzfp = (zzfp) this.zzbkb.get();
                                if (zzfp == null) {
                                    zzfp = new zzfp(view2.getContext(), view2);
                                    this.zzbkb = new WeakReference(zzfp);
                                }
                                zzfp.zza(zzpd.zzks());
                            }
                        }
                ...
                zzane.m27e("Your account must be enabled to use this feature. Talk to your account manager to request this feature for your account.");
                return;
            }
