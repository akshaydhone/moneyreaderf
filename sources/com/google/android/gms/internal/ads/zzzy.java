...
import com.google.android.gms.ads.impl.C0229R;
...
public final class zzzy extends zzaal {
    ...
    final Intent createIntent() {
        ...
        data.putExtra(NotificationTable.COLUMN_NAME_TITLE, this.zzbvs);
    ...
    public final void execute() {
        ...
        if (zzakk.zzao(this.mContext).zziz()) {
            ...
            zzan.setTitle(resources != null ? resources.getString(C0229R.string.s5) : "Create calendar event");
            zzan.setMessage(resources != null ? resources.getString(C0229R.string.s6) : "Allow Ad to create a calendar event?");
            zzan.setPositiveButton(resources != null ? resources.getString(C0229R.string.s3) : "Accept", new zzzz(this));
            zzan.setNegativeButton(resources != null ? resources.getString(C0229R.string.s4) : "Decline", new zzaaa(this));
            zzan.create().show();
            return;
        }
