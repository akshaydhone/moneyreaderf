...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        ...
        long j = this.zzf;
        return new StringBuilder(String.valueOf(valueOf).length() + ModelPPM.MAX_FREQ).append("ActivityRecognitionResult [probableActivities=").append(valueOf).append(", timeMillis=").append(j).append(", elapsedRealtimeMillis=").append(this.zzg).append("]").toString();
    }
