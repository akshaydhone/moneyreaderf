...
public class WakeLock {
    ...
    private final void zza(java.lang.String r13, long r14) {
        ...
        r6 = r12.zzn(r13);
        monitor-enter(r12);
        r0 = r12.zzaed;	 Catch:{ all -> 0x00b9 }
        r0 = r0.isEmpty();	 Catch:{ all -> 0x00b9 }
        if (r0 == 0) goto L_0x0013;
    L_0x000f:
        r0 = r12.zzaee;	 Catch:{ all -> 0x00b9 }
        if (r0 <= 0) goto L_0x0023;
    L_0x0013:
        r0 = r12.zzadv;	 Catch:{ all -> 0x00b9 }
    ...
    L_0x0048:
        ...
        if (r0 != 0) goto L_0x006d;
    L_0x004c:
        r1 = com.google.android.gms.common.stats.WakeLockTracker.getInstance();	 Catch:{ all -> 0x00b9 }
        r2 = r12.zzjp;	 Catch:{ all -> 0x00b9 }
        r0 = r12.zzadv;	 Catch:{ all -> 0x00b9 }
        r3 = com.google.android.gms.common.stats.StatsUtils.getEventKey(r0, r6);	 Catch:{ all -> 0x00b9 }
        r4 = 7;
        r5 = r12.zzadz;	 Catch:{ all -> 0x00b9 }
        r7 = r12.zzaeb;	 Catch:{ all -> 0x00b9 }
        r8 = r12.zzady;	 Catch:{ all -> 0x00b9 }
        r9 = r12.zzdo();	 Catch:{ all -> 0x00b9 }
        r10 = r14;
