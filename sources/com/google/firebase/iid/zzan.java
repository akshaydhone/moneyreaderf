...
public final class zzan {
    ...
    private final int zzb(Context context, Intent intent) {
        ...
        if (str == null) {
            ...
            if (resolveService == null || resolveService.serviceInfo == null) {
                ...
                if (this.zzcn == null) {
                    this.zzcn = Boolean.valueOf(context.checkCallingOrSelfPermission("android.permission.WAKE_LOCK") == 0);
                }
            ...
            if (!context.getPackageName().equals(serviceInfo.packageName) || serviceInfo.name == null) {
                ...
                Log.e("FirebaseInstanceId", new StringBuilder((String.valueOf(str2).length() + 94) + String.valueOf(str).length()).append("Error resolving target intent service, skipping classname enforcement. Resolved service was: ").append(str2).append(InternalZipConstants.ZIP_FILE_SEPARATOR).append(str).toString());
                if (this.zzcn == null) {
    ...
    public final int zza(Context context, String str, Intent intent) {
        ...
        switch (obj) {
            case null:
                this.zzco.offer(intent);
                break;
            case 1:
                this.zzcp.offer(intent);
                break;
            default:
