...
final class zzp {
    ...
    L_0x0022:
        return r0;
    L_0x0023:
        r3 = zzc(r3, r4);	 Catch:{ Throwable -> 0x0041, all -> 0x004b }
        r4 = "cre";
        r0 = r0.getProperty(r4);	 Catch:{ NumberFormatException -> 0x003a }
        r4 = java.lang.Long.parseLong(r0);	 Catch:{ NumberFormatException -> 0x003a }
        r0 = new com.google.firebase.iid.zzq;	 Catch:{ Throwable -> 0x0041, all -> 0x004b }
        r0.<init>(r3, r4);	 Catch:{ Throwable -> 0x0041, all -> 0x004b }
        zza(r1, r2);
        goto L_0x0022;
    L_0x003a:
        r0 = move-exception;
        r3 = new com.google.firebase.iid.zzr;	 Catch:{ Throwable -> 0x0041, all -> 0x004b }
    ...
    L_0x0011:
        r0 = zzf(r6, r7);	 Catch:{ IOException -> 0x0051 }
        ...
        r3 = "pub";
        r4 = r8.zzq();	 Catch:{ IOException -> 0x0051 }
        r2.setProperty(r3, r4);	 Catch:{ IOException -> 0x0051 }
        r3 = "pri";
        r4 = r8.zzr();	 Catch:{ IOException -> 0x0051 }
        r2.setProperty(r3, r4);	 Catch:{ IOException -> 0x0051 }
        r3 = "cre";
        r4 = r8.zzbe;	 Catch:{ IOException -> 0x0051 }
        ...
        r0 = 0;
        zza(r0, r3);	 Catch:{ IOException -> 0x0051 }
    L_0x0049:
        return;
    L_0x004a:
        r1 = move-exception;
    ...
    L_0x004c:
        r0 = move-exception;
        zza(r1, r3);	 Catch:{ IOException -> 0x0051 }
