    ...
    private final String zzn(String str) {
        ...
        try {
            ...
            if (this.zzdc.invoke(notificationManager, new Object[]{"fcm_fallback_notification_channel"}) == null) {
                Object newInstance = Class.forName("android.app.NotificationChannel").getConstructor(new Class[]{String.class, CharSequence.class, Integer.TYPE}).newInstance(new Object[]{"fcm_fallback_notification_channel", this.zzz.getString(C0249R.string.fcm_fallback_notification_channel_label), Integer.valueOf(3)});
                    ...
                    if (runningAppProcessInfo.pid == myPid) {
                        ...
                        if (!TextUtils.isEmpty(zza)) {
                            ...
                            if (intent2 == null) {
                                ...
                                parcelable = PendingIntent.getActivity(this.zzz, this.zzdd.incrementAndGet(), intent2, ErrorDialogData.SUPPRESSED);
                            }
                            if (FirebaseMessagingService.zzk(bundle)) {
                                ...
                                zza3 = zzan.zza(this.zzz, this.zzdd.incrementAndGet(), intent3, ErrorDialogData.SUPPRESSED);
                                intent = new Intent("com.google.firebase.messaging.NOTIFICATION_DISMISS");
                                zza(intent, bundle);
                                zza4 = zzan.zza(this.zzz, this.zzdd.incrementAndGet(), intent, ErrorDialogData.SUPPRESSED);
                            } else {
                                zza4 = null;
                            ...
                            notificationManager = (NotificationManager) this.zzz.getSystemService(NotificationTable.TABLE_NAME);
