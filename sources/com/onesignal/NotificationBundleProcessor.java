...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0004 in list [B:12:0x0064]
...
*/
    ...
    L_0x001f:
        ...
        r10 = 0;
        r0 = r11.getReadableDbWithRetries();	 Catch:{ Throwable -> 0x006e, all -> 0x0082 }
    ...
    L_0x0051:
        ...
        r13.setAndroidIdWithOutOverriding(r1);	 Catch:{ Throwable -> 0x006e, all -> 0x0082 }
    L_0x0062:
    ...
    L_0x006e:
        r12 = move-exception;
        r1 = com.onesignal.OneSignal.LOG_LEVEL.ERROR;	 Catch:{ Throwable -> 0x006e, all -> 0x0082 }
        r2 = "Could not read DB to find existing collapse_key!";	 Catch:{ Throwable -> 0x006e, all -> 0x0082 }
        com.onesignal.OneSignal.Log(r1, r2, r12);	 Catch:{ Throwable -> 0x006e, all -> 0x0082 }
        if (r10 == 0) goto L_0x0004;
    L_0x0078:
        r1 = r10.isClosed();
        if (r1 != 0) goto L_0x0004;
    ...
    static OSNotificationPayload OSNotificationPayloadFrom(JSONObject currentJsonPayload) {
        ...
        try {
            ...
            notification.title = currentJsonPayload.optString(NotificationTable.COLUMN_NAME_TITLE, null);
