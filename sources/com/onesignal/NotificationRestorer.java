...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0004 in list [B:12:0x00b0]
	...
	at jadx.api.JadxDecompiler$$Lambda$8/572593338.run(Unknown Source)
*/
        /*
        r1 = restored;
    ...
    L_0x0005:
        ...
        r14 = 0;
        r14 = r11.getWritableDbWithRetries();	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        r14.beginTransaction();	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        com.onesignal.NotificationBundleProcessor.deleteOldNotifications(r14);	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        r14.setTransactionSuccessful();	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        if (r14 == 0) goto L_0x0026;
    L_0x0023:
        r14.endTransaction();	 Catch:{ Throwable -> 0x00bb }
    L_0x0026:
        ...
        com.onesignal.OneSignal.Log(r1, r2);
        r10 = 0;
        r0 = r11.getReadableDbWithRetries();	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r1 = "notification";	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r2 = COLUMNS_FOR_RESTORE;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r3 = r12.toString();	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r4 = 0;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r5 = 0;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r6 = 0;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r7 = "_id ASC";	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r10 = r0.query(r1, r2, r3, r4, r5, r6, r7);	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r1 = 100;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        showNotifications(r15, r10, r1);	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
    ...
    L_0x00c5:
        r13 = move-exception;
        r1 = com.onesignal.OneSignal.LOG_LEVEL.ERROR;	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        r2 = "Error deleting old notification records! ";	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        com.onesignal.OneSignal.Log(r1, r2, r13);	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        if (r14 == 0) goto L_0x0026;
    L_0x00cf:
        r14.endTransaction();	 Catch:{ Throwable -> 0x00c5, all -> 0x00de, Throwable -> 0x00d4 }
        goto L_0x0026;
    L_0x00d4:
        r13 = move-exception;
        r1 = com.onesignal.OneSignal.LOG_LEVEL.ERROR;
    ...
    L_0x00e1:
        r14.endTransaction();	 Catch:{ Throwable -> 0x00e5 }
    L_0x00e4:
        throw r1;
    L_0x00e5:
        r13 = move-exception;
    ...
    L_0x00ee:
        r13 = move-exception;
        r1 = com.onesignal.OneSignal.LOG_LEVEL.ERROR;	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        r2 = "Error restoring notification records! ";	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        com.onesignal.OneSignal.Log(r1, r2, r13);	 Catch:{ Throwable -> 0x00ee, all -> 0x0103 }
        if (r10 == 0) goto L_0x0004;
    L_0x00f8:
        r1 = r10.isClosed();
        if (r1 != 0) goto L_0x0004;
    ...
    static void startDelayedRestoreTaskFromReceiver(Context context) {
        ...
        ((AlarmManager) context.getSystemService(NotificationCompat.CATEGORY_ALARM)).set(1, scheduleTime, PendingIntent.getService(context, RESTORE_KICKOFF_REQUEST_CODE, intentForService, ErrorDialogData.BINDER_CRASH));
    }
}
