...
class OneSignalRestClient {
    ...
    static void put(final String url, final JSONObject jsonBody, final ResponseHandler responseHandler) {
        new Thread(new Runnable() {
            public void run() {
                OneSignalRestClient.makeRequest(url, "PUT", jsonBody, responseHandler, OneSignalRestClient.TIMEOUT);
            }
        }).start();
    }
    ...
    static void post(final String url, final JSONObject jsonBody, final ResponseHandler responseHandler) {
        new Thread(new Runnable() {
            public void run() {
                OneSignalRestClient.makeRequest(url, "POST", jsonBody, responseHandler, OneSignalRestClient.TIMEOUT);
            }
        }).start();
    }
