...
abstract class UserStateSynchronizer {
    ...
    private final Object networkHandlerSyncLock = new C03002();
    ...
    protected final Object syncLock = new C02991();
    ...
    class C03813 extends ResponseHandler {
        C03813() {
        }
    ...
    L_0x0010:
        ...
        r5 = r9.syncLock;
        monitor-enter(r5);
        r4 = r9.currentUserState;	 Catch:{ all -> 0x003b }
        r6 = r9.getToSyncUserState();	 Catch:{ all -> 0x003b }
        r2 = r4.generateJsonDiff(r6, r1);	 Catch:{ all -> 0x003b }
        r4 = r9.currentUserState;	 Catch:{ all -> 0x003b }
        r4 = r4.dependValues;	 Catch:{ all -> 0x003b }
        r6 = r9.getToSyncUserState();	 Catch:{ all -> 0x003b }
        r6 = r6.dependValues;	 Catch:{ all -> 0x003b }
        r7 = 0;
        r8 = 0;
        r0 = r9.generateJsonDiff(r4, r6, r7, r8);	 Catch:{ all -> 0x003b }
        if (r2 != 0) goto L_0x003e;
    L_0x0033:
        r4 = r9.currentUserState;	 Catch:{ all -> 0x003b }
        r6 = 0;
        r4.persistStateAfterSync(r0, r6);	 Catch:{ all -> 0x003b }
    ...
    L_0x003b:
        ...
        throw r4;
    L_0x003e:
        r4 = r9.getToSyncUserState();	 Catch:{ all -> 0x003b }
        r4.persistState();	 Catch:{ all -> 0x003b }
        monitor-exit(r5);	 Catch:{ all -> 0x003b }
    ...
    private void doEmailLogout(String userId) {
        ...
        OneSignalRestClient.postSync(urlStr, jsonBody, new C03813());
    }
