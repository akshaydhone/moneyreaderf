            ...
            try {
                ...
                for (int i = 0; i < centralDirEntryCount; i++) {
                    ...
                    if (fileNameLength > 0) {
                        ...
                        if (fileName.indexOf(new StringBuffer(":").append(System.getProperty("file.separator")).toString()) >= 0) {
                            fileName = fileName.substring(fileName.indexOf(new StringBuffer(":").append(System.getProperty("file.separator")).toString()) + 2);
                        }
