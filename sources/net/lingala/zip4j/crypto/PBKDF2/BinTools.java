...
class BinTools {
    ...
    public static byte[] hex2bin(String s) {
        ...
        if (s == null) {
            ...
            m = new StringBuffer("0").append(s).toString();
        }
    ...
    public static int hex2bin(char c) {
        ...
        throw new IllegalArgumentException(new StringBuffer("Input string may only contain hex digits, but found '").append(c).append("'").toString());
    }
}
