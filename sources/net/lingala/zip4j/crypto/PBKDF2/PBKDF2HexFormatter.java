...
class PBKDF2HexFormatter {
    ...
    public String toString(PBKDF2Parameters p) {
        return new StringBuffer(String.valueOf(BinTools.bin2hex(p.getSalt()))).append(":").append(String.valueOf(p.getIterationCount())).append(":").append(BinTools.bin2hex(p.getDerivedKey())).toString();
    }
}
