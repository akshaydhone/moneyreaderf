...
public class AESEngine {
    /* renamed from: S */
    private static final byte[] f10S;
    ...
    private final void encryptBlock(int[][] KW) {
        ...
        r = r4 + 1;
        r3 = (((T0[this.C3 & 255] ^ shift(T0[(this.C0 >> 8) & 255], 24)) ^ shift(T0[(this.C1 >> 16) & 255], 16)) ^ shift(T0[(this.C2 >> 24) & 255], 8)) ^ KW[r4][3];
        this.C0 = ((((f10S[r0 & 255] & 255) ^ ((f10S[(r1 >> 8) & 255] & 255) << 8)) ^ ((f10S[(r2 >> 16) & 255] & 255) << 16)) ^ (f10S[(r3 >> 24) & 255] << 24)) ^ KW[r][0];
        this.C1 = ((((f10S[r1 & 255] & 255) ^ ((f10S[(r2 >> 8) & 255] & 255) << 8)) ^ ((f10S[(r3 >> 16) & 255] & 255) << 16)) ^ (f10S[(r0 >> 24) & 255] << 24)) ^ KW[r][1];
        this.C2 = ((((f10S[r2 & 255] & 255) ^ ((f10S[(r3 >> 8) & 255] & 255) << 8)) ^ ((f10S[(r0 >> 16) & 255] & 255) << 16)) ^ (f10S[(r1 >> 24) & 255] << 24)) ^ KW[r][2];
        this.C3 = ((((f10S[r3 & 255] & 255) ^ ((f10S[(r0 >> 8) & 255] & 255) << 8)) ^ ((f10S[(r1 >> 16) & 255] & 255) << 16)) ^ (f10S[(r2 >> 24) & 255] << 24)) ^ KW[r][3];
    }
    ...
    private int subWord(int x) {
        return (((f10S[x & 255] & 255) | ((f10S[(x >> 8) & 255] & 255) << 8)) | ((f10S[(x >> 16) & 255] & 255) << 16)) | (f10S[(x >> 24) & 255] << 24);
    }
    ...
    static {
        ...
        bArr[81] = (byte) -47;
        bArr[83] = (byte) -19;
        bArr[84] = VMCmdFlags.VMCF_USEFLAGS;
        bArr[85] = (byte) -4;
        bArr[86] = (byte) -79;
        bArr[87] = (byte) 91;
        bArr[88] = (byte) 106;
        ...
        bArr[112] = (byte) 81;
        bArr[113] = (byte) -93;
        bArr[114] = VMCmdFlags.VMCF_CHFLAGS;
        bArr[115] = (byte) -113;
        bArr[116] = (byte) -110;
        bArr[117] = (byte) -99;
        bArr[118] = (byte) 56;
        ...
        bArr[122] = (byte) -38;
        bArr[123] = (byte) 33;
        bArr[ModelPPM.MAX_FREQ] = VMCmdFlags.VMCF_PROC;
        bArr[125] = (byte) -1;
        bArr[126] = (byte) -13;
        bArr[127] = (byte) -46;
        bArr[128] = (byte) -51;
        bArr[GmsClientSupervisor.DEFAULT_BIND_FLAGS] = (byte) 12;
        bArr[130] = (byte) 19;
        bArr[131] = (byte) -20;
        bArr[132] = (byte) 95;
        bArr[133] = (byte) -105;
        ...
        iArr[127] = 1842533055;
        iArr[128] = 1288555905;
        iArr[GmsClientSupervisor.DEFAULT_BIND_FLAGS] = 336333848;
        iArr[130] = 890442534;
        iArr[131] = 804056259;
        iArr[132] = -513843266;
        iArr[133] = -1567123659;
