...
public class CRCUtil {
    ...
    public static long computeFileCRC(java.lang.String r8, net.lingala.zip4j.progress.ProgressMonitor r9) throws net.lingala.zip4j.exception.ZipException {
        /*
        r6 = net.lingala.zip4j.util.Zip4jUtil.isStringNotNullAndNotEmpty(r8);
    ...
    L_0x000e:
        r3 = 0;
        net.lingala.zip4j.util.Zip4jUtil.checkFileReadAccess(r8);	 Catch:{ IOException -> 0x0069, Exception -> 0x0077 }
    ...
    L_0x0069:
        r2 = move-exception;
    L_0x006a:
        r6 = new net.lingala.zip4j.exception.ZipException;	 Catch:{ all -> 0x0070 }
